...
class MainproductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.content.mainproduct.create',[ 'categories' => $categories, 'brands' => $brands]);
    }
    ...
    public function storeproduct(Request $request)
    {
        ...
        $mainproduct->brand_id = $request->brand_id;
    ...
    public function edit($id)
    {
        ...
        $categories = Category::where('status', 'Active')->select('id', 'category_name', 'status')->get();
        $brands = Brand::where('status', 'Active')->select('id', 'brand_name', 'status')->get();
        return view('backend.content.mainproduct.edit', ['mainproduct' => $mainproduct, 'categories'=>$categories, 'brands'=>$brands]);
    }
