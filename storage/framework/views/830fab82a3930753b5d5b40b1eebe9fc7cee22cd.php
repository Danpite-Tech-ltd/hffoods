                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select id="supplierID"  class="form-control">
                                        <option value="1" selected ><?php echo e(env('APP_NAME')); ?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6">
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\premium\hffoods\resources\views/admin/content/purchase/create.blade.php ENDPATH**/ ?>