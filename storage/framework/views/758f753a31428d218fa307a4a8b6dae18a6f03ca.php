...
<?php $__env->startSection('title'); ?>
    <?php echo e(env('APP_NAME')); ?>- Add Banners
            ...
            <div class="bg-secondary rounded h-100 p-4">
                <div class="data-tables">
                    <table class="table table-dark" id="sliderinfo" width="100%" style="text-align: center;">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $addbanners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addbanner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="">
                                    <td><?php echo e($addbanner->id); ?></td>
                                    <td>
                                        <img src="<?php echo e(asset($addbanner->add_image)); ?>" alt="" srcset=""
                                            style="height: 140px;">
                                    </td>
                                    <td><?php echo e($addbanner->add_link); ?></td>
                                    <td>
                                        <?php if($addbanner->status == 'Active'): ?>
                                            <form action="<?php echo e(url('admin/addbanner/status/' . $addbanner->id)); ?>"
                                                method="post">
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.addbanners.edit', $addbanner->id)); ?>" type="button"
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\premium\hffoods\resources\views/backend/content/addbanner/index.blade.php ENDPATH**/ ?>