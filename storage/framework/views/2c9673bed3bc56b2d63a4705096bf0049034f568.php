        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <div class="h-100 bg-secondary rounded p-4 pb-0">
                ...
                <div class="" style="width: 50%;float:left;">
                    <a href="<?php echo e(route('admin.blogs.create')); ?>" class="btn btn-primary m-2" style="float: right"> + Add
                        New Blogs</a>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        var bloginfo = $('#bloginfo').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('admin.blog.data'); ?>',
            columns: [{
                    data: 'id'
                }, {
                    data: 'image',
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\premium\hffoods\resources\views/backend/content/blog/index.blade.php ENDPATH**/ ?>