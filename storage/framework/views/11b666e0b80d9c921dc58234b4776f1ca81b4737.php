...
<?php $__env->startSection('title'); ?>
    <?php echo e(env('APP_NAME')); ?>- Shop Product
        ...
        <div class="col-12 col-lg-3">
            <div class="shop-category-box">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(url('shop?category='.$category->slug)); ?>" class="category-item">
        ...
        <div class="col-12 col-lg-9">
            <div style="display: flex;align-items: center;justify-content: space-between;">
                <div style="text-align:right;font-size:14px;color:#666;font-weight:500;margin:20px 0;">
                    Showing <?php echo e($shops->firstItem()); ?>–<?php echo e($shops->lastItem()); ?> of <?php echo e($shops->total()); ?> results
                </div>
            ...
            <div class="pt-2 pb-2 row" id="cateoryPro" style="background: white;">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotional): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
            ...
            <div class="pagination-wrapper">
                <ul class="pagination">
                    ...
                    <?php if($shops->onFirstPage()): ?>
                        <li class="disabled"><span>«</span></li>
                    <?php else: ?>
                        <li>
                            <a href="<?php echo e($shops->previousPageUrl()); ?>">«</a>
                        </li>
                    <?php endif; ?>

                    
                    <?php for($i = 1; $i <= $shops->lastPage(); $i++): ?>
                        <?php if($i == $shops->currentPage()): ?>
                            <li class="active"><span><?php echo e($i); ?></span></li>
                        <?php else: ?>
                            <li>
                                <a href="<?php echo e($shops->url($i)); ?>"><?php echo e($i); ?></a>
                            </li>
                        <?php endif; ?>
                    <?php endfor; ?>

                    
                    <?php if($shops->hasMorePages()): ?>
                        <li>
                            <a href="<?php echo e($shops->nextPageUrl()); ?>">»</a>
                        </li>
                    <?php else: ?>
                        <li class="disabled"><span>»</span></li>
                    <?php endif; ?>
...
<?php echo $__env->make('webview.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\premium\hffoods\resources\views/webview/content/product/shop.blade.php ENDPATH**/ ?>