...
<nav class="px-4 py-0 navbar navbar-expand bg-secondary navbar-dark sticky-top">
    ...
    <div class="d-md-flex ms-4 d-none d-lg-block">
        ...
        <a style="font-size: 26px;float: left;margin-right: 25px;text-transform: uppercase;font-weight: bold;color: #0c0c70;"><?php echo e(env('APP_NAME')); ?></a>
    </div>
...
<div class="mt-3 d-md-flex d-block d-lg-none" style="    text-align: center;">
    <a target="_blank" href="<?php echo e(url('/')); ?>" class="mb-2 btn btn-info">View Website</a>
    <a target="_blank" href="<?php echo e(url('admin/user/report')); ?>" class="mb-2 btn btn-warning ms-3">User Order</a>
    <a target="_blank" href="<?php echo e(url('/admin/stock/overview')); ?>" class="mb-2 btn btn-success ms-3">Inventory</a>
    <a target="_blank" href="<?php echo e(url('/complain/Pending')); ?>" class="mb-2 btn btn-danger ms-3">Complain</a>
    <a target="_blank" href="<?php echo e(url('admin/tasks')); ?>" class="mb-2 btn btn-warning ms-3">My Task</a>
...
<?php /**PATH D:\xampp\htdocs\premium\hffoods\resources\views/backend/partials/header.blade.php ENDPATH**/ ?>