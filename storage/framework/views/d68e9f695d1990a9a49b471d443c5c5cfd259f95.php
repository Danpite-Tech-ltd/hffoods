    ...
    <div class="mb-4 row g-4">
        <div class="card card-body">
            <div class="mb-4 text-center col-12">
                <h4 style="margin: 0;margin-top: 8px;"><?php echo e(env('APP_NAME')); ?></h4>
            </div>
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\premium\hffoods\resources\views/backend/content/maincontent.blade.php ENDPATH**/ ?>