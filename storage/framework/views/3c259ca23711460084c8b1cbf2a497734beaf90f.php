                            ...
                            <div class="mb-3">
                                ...
                                <select name="courier" id="courier" required
                                    ...
                                    <?php if($webinfo->courier == '1'): ?>
                                        <option value="1" selected><?php echo e(env('APP_NAME')); ?> Courier</option>
                                        
                                    <?php else: ?>
                                        <option value="1"><?php echo e(env('APP_NAME')); ?> Courier</option>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <div class="mb-3 form-floating">
                                ...
                                value="<?php echo e(\Carbon\Carbon::parse($webinfo->flash_sale_time)->format('Y-m-d\TH:i')); ?>" id="flash_sale_time"
                            ...
                            <div class="mb-3 form-floating">
                                ...
                                value="<?php echo e(\Carbon\Carbon::parse($webinfo->banner_time)->format('Y-m-d\TH:i')); ?>" id="banner_time"
                            ...
                            <div class="mb-3 form-floating">
                                <input type="text" class="form-control" name="banner_subtitle"
                                    value="<?php echo e($webinfo->banner_subtitle); ?>" id="banner_subtitle"
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3 form-floating">
                                <input type="text" class="form-control" name="banner_title"
                                    value="<?php echo e($webinfo->banner_title); ?>" id="banner_title"
                                    placeholder="Banner Title">
                                <label for="floatingInput">Banner Title</label>
                            </div>
                            <div class="mb-3 form-floating">
                                <input type="text" class="form-control" name="banner_link"
                                    value="<?php echo e($webinfo->banner_link); ?>" id="banner_link"
                            ...
                            <div class="mt-2">
                                <img src="<?php echo e(asset($basicinfo->banner_img)); ?>" alt="" width="50">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mt-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3 form-floating">
                                <input type="text" class="form-control" name="sub_dhaka_charge"
                                    value="<?php echo e($webinfo->sub_dhaka_charge); ?>" id="sub_dhaka_charge"
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\premium\hffoods\resources\views/backend/content/basicinfo/index.blade.php ENDPATH**/ ?>