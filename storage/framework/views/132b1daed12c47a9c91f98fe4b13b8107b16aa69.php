<?php $__env->startSection('maincontent'); ?>
    ...
    <?php $__env->startSection('meta'); ?>
        ...
        <meta property="og:url" content="<?php echo e(env('APP_URL')); ?>view-product/<?php echo e($productdetails->ProductSlug); ?>">
        ...
        <meta property="url" content="<?php echo e(env('APP_URL')); ?>view-product/<?php echo e($productdetails->ProductSlug); ?>">
        <meta itemprop="image" content="<?php echo e(env('APP_URL')); ?><?php echo e($productdetails->ProductImage); ?>">
                        ...
                        <div class="row wow fadeInUp">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 gallery-holder">
                                <div class="product-item-holder size-big single-product-gallery small-gallery">
                                    ...
                                    <!--                    src="<?php echo e(asset('public/images/product/slider')); ?>/<?php echo e($image); ?>"-->
                                    <!--                    alt="" style="border-radius: 4px;">-->
                                    <!--            </div>-->
                                                    ...
                                                    <div class="colorinfo">
                                                        <?php $__empty_1 = true; $__currentLoopData = json_decode($singlemain->RelatedProductIds); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ids): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            ...
                                                            <?php if(isset($prodinfo)): ?>
                                                                <input type="radio" class="m-0" id="relproduct<?php echo e($prodinfo->id); ?>"
                                                                ...
                                                                <label class="relproduct ms-0" id="relproducttext<?php echo e($prodinfo->id); ?>"
                                                                    ...
                                                                    onclick="getrelproduct('<?php echo e($prodinfo->id); ?>','<?php echo e($singlemain->id); ?>')">
                                                                    <img src="<?php echo e(asset($prodinfo->ProductImage)); ?>" alt=""
                                                                        style="width:60px;">
                                                                </label>
                                                            <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                    ...
                                                    <?php $__empty_1 = true; $__currentLoopData = $sizesolds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sizesold): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        <?php if($sizesold->available_stock > 0): ?>
                                                            ...
                                                            <input type="hidden" name="salepriceofsize"
                                                                id="salepriceofsize<?php echo e($sizesold->id); ?>"
                                                                value="<?php echo e($sizesold->SalePrice); ?>">
                                                            <input type="radio" class="m-0" hidden id="size<?php echo e($sizesold->id); ?>"
                                                                name="size" onclick="getsize('<?php echo e($sizesold->id); ?>')">
                                            ...
                                            <div class="col-12 col-md-12 colorpart">
                                                ...
                                                <div class="sizeinfo">
                                                    <?php $__empty_1 = true; $__currentLoopData = $weightolds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $weight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                        ...
                                                        <input type="hidden" name="salepriceofsize"
                                                            id="salepriceofsize<?php echo e($weight->id); ?>" value="<?php echo e($weight->SalePrice); ?>">
                                                        <input type="hidden" name="weightsigmrnt"
                                                            id="weightsigmrnt<?php echo e($weight->id); ?>" value="<?php echo e($weight->weight); ?>">
                                                        <input type="radio" class="m-0" hidden id="size<?php echo e($weight->id); ?>"
                                                            name="size" onclick="getweight('<?php echo e($weight->id); ?>')">
                                    ...
                                    <div class="text-center quantity-container info-container"
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-6 col-lg-6">
                                                <a href="https://wa.me/<?php echo e($basicinfo->phone_one); ?>" target="_blank" style="background:#1cab64 !important;color:white;font-size: 14px;border-radius:6px;w-didth:100%;padding: 8px 0;display: block;" class="text-center" id="orderwhatsapp">
                                                   <i style="font-size: 17px;;" class="fa-brands fa-whatsapp"></i> Order on WhatsApp
                                                </a>
                                            </div>
                                            <div class="col-6 col-lg-6">
                                                <a href="tel:<?php echo e($basicinfo->phone_one); ?>" target="_blank" style="background:#1e3a8b !important;color:white;font-size: 15px;border-radius:6px;w-didth:100%;padding: 8px 0;display: block;" class="text-center" id="orderwhatsapp">
