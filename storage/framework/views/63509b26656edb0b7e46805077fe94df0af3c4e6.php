...
<div class="pt-2 pb-2 row" id="cateoryPro" style="background:#efefef !important;">
    ...
    <div class="pb-2 bg-white">
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    <div class="title-top">
                        <span class="bar"></span>
                        <span class="category-text"><?php echo e($subcategory->sub_category_name); ?> Products</span>
                    </div>
        ...
        <div class="row g-4">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $subcategoryproducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promotional): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
            ...
            <?php endif; ?>
            <!-- </div> -->
            <?php if($subcategoryproducts->hasPages()): ?>
                <div class="pagination-wrapper">
                    <ul class="pagination">

                        
                        <?php if($subcategoryproducts->onFirstPage()): ?>
                            <li class="disabled"><span>«</span></li>
                        <?php else: ?>
                            <li>
                                <a href="<?php echo e($subcategoryproducts->previousPageUrl()); ?>">«</a>
                            </li>
                        <?php endif; ?>

                        
                        <?php for($i = 1; $i <= $subcategoryproducts->lastPage(); $i++): ?>
                            <?php if($i == $subcategoryproducts->currentPage()): ?>
                                <li class="active"><span><?php echo e($i); ?></span></li>
                            <?php else: ?>
                                <li>
                                    <a href="<?php echo e($subcategoryproducts->url($i)); ?>"><?php echo e($i); ?></a>
                                </li>
                            <?php endif; ?>
                        <?php endfor; ?>

                        
                        <?php if($subcategoryproducts->hasMorePages()): ?>
                            <li>
                                <a href="<?php echo e($subcategoryproducts->nextPageUrl()); ?>">»</a>
                            </li>
                        <?php else: ?>
                            <li class="disabled"><span>»</span></li>
                        <?php endif; ?>
...
<?php /**PATH D:\xampp\htdocs\premium\hffoods\resources\views/webview/content/product/subview.blade.php ENDPATH**/ ?>