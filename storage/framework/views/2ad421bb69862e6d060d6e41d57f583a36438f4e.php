...
<header class="header-style-1">
    ...
    <div class="top-barhead animate-dropdown" id="">
        <div class="header-top-inner">
            <div class="container" style="display:flex; align-items:center;justify-content:space-between;">
                ...
                <!--    <?php echo e($basicinfo->marquee_text); ?>-->
                <!--    -->
                <!--</p>-->
                <div>
                    <p class="m-0 text-white">Contact: <?php echo e($basicinfo->phone_one); ?></p>
                </div>
                <div class="gap-3 d-flex ">
                    <a href="<?php echo e($basicinfo->facebook); ?>" target="_blank" class="text-white fs-5"><i class="fa-brands fa-facebook-f"></i></a>
                    <!--<a href="<?php echo e($basicinfo->twitter); ?>" class="text-white-50 fs-5"><i class="fa-brands fa-twitter"></i></a>-->
                    <a href="<?php echo e($basicinfo->linkedin); ?>" target="_blank" class="text-white fs-5"><i class="fa-brands fa-instagram"></i></a>
                    <a href="<?php echo e($basicinfo->youtube); ?>" target="_blank" class="text-white fs-5"><i class="fa-brands fa-tiktok"></i></a>
                    <a href="mailto:<?php echo e($basicinfo->email); ?>" target="_blank" class="text-white fs-5"><i class="fa-solid fa-envelope"></i></a>
                </div>
            </div>
        </div>
    </div>
    <div class="main-header" id="myHeader" style="background: #fff;border-bottom: 1px solid #e9e9e9;">
        <div class="container">
            <div class="row" id="d-sm-none" style="" class="pcview_margin ">
                <div class="col-6 col-sm-6 col-md-6 col-lg-2 logo-holder ps-0">
                    ...
                    <div class="logo" style="display: flex;justify-content:start;align-items:center">
                        ...
                        <a href="<?php echo e(url('/')); ?>" id="logoimage">
                            <img src="<?php echo e(asset($basicinfo->logo)); ?>" alt="" id="logosm"
                                style="    width: 100%;">
                        </a>
                    </div>
                    <!-- /.logo -->
                ...
                <div class="p-0 col-6 col-sm-6 col-md-6 col-lg-6 animate-dropdown top-cart-row top-search-holder" id="headcart">
                    ...
                    <div class="">
                        <a href="<?php echo e(url('/wishlist')); ?>" class="d-none d-lg-block" id="iconhead" style="margin-top:2px !important">
                           <i class="bi bi-heart" style="font-size:21px;color:black;"></i>
                        </a>
                    </div>

                    <div class="dropdown-cart" id="d-sm-none" style="margin-left:-15px;margin-top:2px">
                            ...
                            <div class="items-cart-inner">
                                <div class="basket" style="padding: 0;display:flex;">
                                    <span style="color: #212129;font-weight:bold;position:relative">
                                        <span style="    position: absolute;right: -13px;top: -11px;"><?php echo e(intval(Cart::count())); ?></span>
                    ...
                    <div class="d-none d-xl-inline-block" id="d-sm-none">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(url('login')); ?>" id="iconhead" style="padding-right: 16px;font-size:23px">
                    ...
                    <!--    id="smsericon">-->
                        <!-- <img src="<?php echo e(asset('public/search.png')); ?>" style="width:25px"> -->
                    ...
                    <!--<div class="d-lg-none">-->
                    <!--    <a href="<?php echo e(url('/wishlist')); ?>" class="" id="iconhead">-->
                    ...
                    <!--            <span style="color: #000;position: absolute;top: -32px;right: -9px;"><?php echo e(count(Cart::content())); ?></span>-->
               ...
               <div class="left-col d-flex align-items-center justify-content-between">
                ...
                <div class="middle-col d-flex align-items-center justify-content-center">
                    <a href="<?php echo e(url('/')); ?>">
                        <img src="<?php echo e(asset($basicinfo->logo)); ?>" alt="" style="width:100%;">
                    </a>
                </div>
            ...
            <div class="px-3 pb-3 side-login" style="padding-top: 12px;padding-bottom: 15px; padding-left: 10px;">
                <?php if(Auth::guard('web')->check()): ?>
                    <?php if(Auth::guard('web')->user()->profile): ?>
                        ...
                        <img src="<?php echo e(asset(Auth::guard('web')->user()->profile)); ?>" alt=""
                            id="profileImage">
                    <?php else: ?>
                    ...
                    <h4 class="m-0 text-left" style="color: white;font-size: 16px;text-transform: uppercase;">
                        <?php echo e(Auth::guard('web')->user()->name); ?></h4>
                    <h4 class="m-0 text-left" style="color: white;font-size: 16px;">
                        <?php echo e(Auth::guard('web')->user()->email); ?></h4>
                <?php else: ?>
                <?php endif; ?>
            ...
            $.get('/live-search', { search: query }, function (data) {
                ...
                if (!data.length) {
                    ...
                    $.each(data, function (i, p) {
                       const img = p.image
                            ? `<img src="<?php echo e(asset('')); ?>${p.image}" style="width:50px;height:50px;object-fit:cover;border-radius:5px;">`
...
</script><?php /**PATH D:\xampp\htdocs\premium\hffoods\resources\views/webview/partials/header.blade.php ENDPATH**/ ?>