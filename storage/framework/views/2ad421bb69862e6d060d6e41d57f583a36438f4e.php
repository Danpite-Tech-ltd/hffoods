        ...
        <div class="header-top-inner">
            <div class="d-sm-none">
                <div class="container" style="display:flex; align-items:center;justify-content:space-between;">
                    ...
                    <div class="d-flex" style="gap: 15px;align-items:center;">
                        ...
                        <!-- Call link -->
                        <a href="tel:<?php echo e($basicinfo->phone_one); ?>" title="<?php echo e($basicinfo->phone_one); ?>"
                            class="m-0 text-white" style="font-size:14px">
                            <i class="fa-solid fa-phone"></i> <?php echo e($basicinfo->phone_one); ?>

                        </a>
                        <!-- WhatsApp link -->
                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $basicinfo->wp_1)); ?>" target="_blank"
                            title="<?php echo e($basicinfo->wp_1); ?>" class="m-0 text-white" style="font-size:14px">
                            <i class="fa-brands fa-whatsapp" style="font-size:17px"></i> <?php echo e($basicinfo->wp_1); ?>
            ...
            <div class="text-center d-lg-none">
                ...
                <div class="d-flex justify-content-center" style="gap: 15px;align-items:center;">
                    <a href="tel:<?php echo e($basicinfo->phone_one); ?>" title="<?php echo e($basicinfo->phone_one); ?>" class="m-0 text-white"
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-2 logo-holder ps-0">
                    ...
                    <div class="logo" style="display: flex;justify-content:start;align-items:center">
                        ...
                        <a href="<?php echo e(url('/')); ?>" id="logoimage">
                            <img src="<?php echo e(asset($basicinfo->logo)); ?>" alt="" id="logosm" style="    width: 100%;">
                        </a>
                    </div>
                    <!-- /.logo -->
                    <!-- ============================================================= LOGO : END ============================================================= -->
                            ...
                            <div class="items-cart-inner">
                                <div class="basket" style="padding: 0;display:flex;">
                                    <span style="color: #212129;font-weight:bold;position:relative">
                                        <span
                                            style="    position: absolute;right: -13px;top: -11px;"><?php echo e(intval(Cart::count())); ?></span>
