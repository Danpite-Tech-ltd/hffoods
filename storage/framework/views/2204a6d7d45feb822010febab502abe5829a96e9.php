                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form name="form" id="AddCoupon" enctype="multipart/form-data">
                            ...
                            <input type="date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" name="date" id="date" hidden>
                            ...
                            <div class="form-group pb-3">
                                ...
                                <div class="webtitle">
                                    <input type="date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" name="validity" id="validity" required>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
           ...
           var couponinfotbl = $('#couponinfo').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '<?php echo route('admin.coupon.data'); ?>',
                columns: [
                    { data: 'id' },
                    { data: 'code' },
                    { data: 'type' },
            ...
            $('#AddCoupon').submit(function(e){
                ...
                $.ajax({
                    type:'POST',
                    uploadUrl:'<?php echo e(route("admin.coupons.store")); ?>',
                    processData: false,
                    contentType: false,
...
<?php echo $__env->make('backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\premium\hffoods\resources\views/admin/content/coupon/coupon.blade.php ENDPATH**/ ?>