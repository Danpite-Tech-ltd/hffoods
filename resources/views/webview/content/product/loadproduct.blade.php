                    ...
                    <div class="product-item-holder size-big single-product-gallery small-gallery">
                        ...
                        @if(json_decode($productdetails->PostImage))
                            <div id="sync1" class="owl-carousel owl-theme">
                                @if($productdetails->youtube_embade)
                                    <div class="items">
                                        {{-- <img class="w-100 h-100 block__pic"
                                            src="{{ asset($productdetails->ProductImage) }}" alt="" style="border-radius: 4px;">
                                        --}}
                                ...
                                <div class="col-12">
                                    @if (App\Models\Size::where('product_id', $productdetails->id)->first())
                                        <div class="product-price strong-700"
                                            ...
                                            style="color: #fe0909;font-size: 20px;">{{ round(App\Models\Size::where('product_id', $productdetails->id)->first()->RegularPrice) }}TK</del>@endif
                                        </div>
                                    @else
                                        <div class="product-price strong-700"
                                            style="color:black;font-weight:bold;padding-top: 6px;" id="productPriceAmount">
                                    ...
                                    <div class="sizeinfo">
                                        @forelse ($sizes as $sizesold)
                                            @if ($sizesold->available_stock > 0)
                                                ...
                                                <input type="hidden" name="salepriceofsize" id="salepriceofsize{{ $sizesold->id }}"
                                                    value="{{ $sizesold->SalePrice }}">
                                                <input type="radio" class="m-0" hidden id="size{{ $sizesold->id }}" name="size"
                                ...
                                <div class="col-12 col-md-12 colorpart">
                                    ...
                                    <div class="sizeinfo">
                                        @forelse ($weights as $weight)
                                            <input type="hidden" name="regularpriceofsize"
                                                id="regularpriceofsize{{ $weight->id }}" value="{{ $weight->RegularPrice }}">
                                            <input type="hidden" name="salepriceofsize" id="salepriceofsize{{ $weight->id }}"
                                                value="{{ $weight->SalePrice }}">
                                            <input type="hidden" name="weightsigmrnt" id="weightsigmrnt{{ $weight->id }}"
                                                value="{{ $weight->weight }}">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="short_desc" class="tab-pane fade show active">
                            <p>{!! $productdetails->ProductBreaf !!}</p>
                        </div>
