            ...
            <div class="row">
                ...
                <div class="col-12 col-md-25 d-none" id="left">
                    ...
                    <div class="gap-3 pt-3 mt-3 d-flex ">
                        <a href="{{ $basicinfo->facebook }}" target="_blank" class="text-white-50 fs-5"><i class="fa-brands fa-facebook-f"></i></a>
                        <!--<a href="{{ $basicinfo->twitter }}" class="text-white-50 fs-5"><i class="fa-brands fa-twitter"></i></a>-->
                        <a href="{{ $basicinfo->linkedin }}" target="_blank" class="text-white-50 fs-5"><i class="fa-brands fa-instagram"></i></a>
                        <a href="{{ $basicinfo->email }}" target="_blank" class="text-white-50 fs-5"><i class="fa-brands fa-tiktok"></i></a>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="module-heading">
                        <p class="text-center" style="font-size: 12px;color:white">Copyright © 2025 -
                            {{ env('APP_NAME') }} | Developed by <a target="_blank" href="https://danpitetech.com/">Danpite Tech</a>
                        </p>
                    </div>
                </div>
            </div>
